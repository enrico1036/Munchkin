...
public class MyPanel extends JPanel implements MouseListener, MouseMotionListener,ActionListener {
	...
	public void mouseReleased(MouseEvent e) {
		if(inButton){
			 ...
			 * 
			 * solo che secondo me � un po' una porcata
			 * infatti volevo fa in modo che i singoli pannelli implementassero il
			 * metodo mouseListener e non il pannellone MyPanel come � adesso.
			 * 
			 * Hai colto nel segno..cosi funziona ma non è bello, ogni pannello si dovrebbe gestire da solo
