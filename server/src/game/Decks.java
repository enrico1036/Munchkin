...
public class Decks {
	...
	/**
	 * Load the decks with the card in the xml file it's MANDATORY to call this method only one time at the begin of the game
	 */
	...
	/**
	 * Used to get a card from door deck assume that treasure deck is already loaded returns: the first card if deck has almost one, while fill deck with discard deck and shuffle it if deck was empty
	 */
	...
	/**
	 * Used to get a card from treasure deck assume that treasure deck is already loaded returns: the first card if deck has almost one, while fill deck with discard deck and shuffle it if deck was empty
	 */
